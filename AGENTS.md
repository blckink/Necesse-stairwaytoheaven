...
python3 tools/category_table.py <log> # item categories from a server log's swhcat lines
                                      # (reading tool; the gate is the integration
                                      # test's `swhcat census: ... bad=0`)
