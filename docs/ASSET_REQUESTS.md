...
| ~~Paradise Fern~~ **DONE 2026-09-09** and ~~Giant Monstera~~ **DONE 2026-09-09** — separate own object IDs and sheets; Adam's Vine remains on the shared stand-in | `paradisefern`, `giantmonstera`; `adamsvine` still aliases `swampgrass` | `objects/paradisefern.png`, `objects/giantmonstera.png`; `objects/swampgrass.png` remains for Adam's Vine | **256×32 each** | Eight separate 32px variants per sheet. |
