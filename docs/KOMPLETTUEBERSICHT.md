...
| D | Ives ansprechen | Steinfeld, neben einem Zerbrochenen Engel (14 %/Region) | 14× Grabsalz, 10× Geistermoos | 12× Sturmstahlbarren, **Gebühr 3 000 entfällt** | Ives gratis | **`swh_steinfeldvigil`** | `W.residentChainsDone += "steinfeldvigil"` | `mobs/IvesMob.java:150-170`, `quest/SkyQuests.java:109-130` |
