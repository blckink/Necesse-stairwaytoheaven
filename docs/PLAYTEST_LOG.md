...
| Houses plain, same furniture | Town, inn and toll bridge rebuilt as furnished plans — see the entry "Skyreach houses" further down. | **FIXED — NOT YET PLAYER CONFIRMED** |
