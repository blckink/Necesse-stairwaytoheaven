...
| `mobs/sheep`, `mobs/sheep_sheared`, `mobs/ram`, `mobs/ram_sheared`, `mobs/lamb` (sheets, recoloured at load time) | the Glimmergoat's five states on the mod's own sheets, supplied already on vanilla's grid — `gimmergoat-doe`, `gimmergoat-doe_shorn`, `gimmergoat-ram`, `gimmergoat-ram_shorn`, `glimmergoat-lamb`. The file names are the player's and are kept verbatim | 2026-09-02 |
