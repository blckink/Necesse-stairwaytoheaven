...
| 2026-09-25 | shrunkenheads (Twilight Merchant wall piece, never shipped) | 64x256 sheet + 32x32 icon | 3 | 1/1 | the 2026-09-17 candidate (build/twilight5c) was drawn TALL (60 px, cords from one nail) and only fit the 30 px wall face shrunk to 27x28 with 10 px heads; the brief gave the old master as motif ref, the shipped mirror/eye as layout refs and the box as numbers ("front x10..54, y34..62, never above y33, heads side by side") - met first pass: 806 px front, 176 px sides, 40 colours; the three faces are nearly alike | shipped, not yet seen in game |
| 2026-09-25 | outfiticons (9 Twilight outfit item icons below the vanilla band) | 9 icons 32x32, 6 jobs | 2.2-4.1 (SLOTS=3) + fix 2.4/3.5 | 7/9 first pass, 9/9 after one fix | brief gave hard numbers per kind (chest 28x26-28, 450-650 px, bottom y28-30; legs two legs 26-30 wide; shoes pair 28-30x15-17) plus old icon, worn front cell, vanilla icons and passing siblings as refs - all nine came back at 28 px wide and 0.80-1.07 of vanilla mass. Misses: hauntedpuppet stripes red/white/blue because MY brief named the colours wrong (worn sheet is rainbow); twilightsuit shoes read as black lumps on dark ground - fix pass asked for dark grey-purple + light rim | shipped, not yet seen in game |
| 2026-09-25 | veterancatapult rows 0/2 (player: N/S "riesen Räder", E/W Räder 1/3 so groß) | two 384x128 strips, 2 jobs | 3.9 / ~5 | 2/2 | east idle as canonical scale ref + hard numbers (wheel 26-30 px, track x22..74, ground y126, "equal SCALE, not equal size") came back right first pass; north frames 1-3 had a few stray pixels beside the carriage |
