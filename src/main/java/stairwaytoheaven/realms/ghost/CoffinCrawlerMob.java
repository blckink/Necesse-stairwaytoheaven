...
public class CoffinCrawlerMob extends DesertCrawlerMob {
    ...
    /**
     * Bestiary face: it subclasses DesertCrawlerMob, so it wears that creature's
    ...
    public necesse.gfx.gameTexture.GameTexture getMobIcon() {
        return stairwaytoheaven.mobs.BorrowedMobIcon.from("desertcrawler", super.getMobIcon());
    }
