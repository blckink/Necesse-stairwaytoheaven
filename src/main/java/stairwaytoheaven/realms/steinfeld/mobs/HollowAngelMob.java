...
public class HollowAngelMob extends CrystalGolemMob {
    ...
    /**
     * Bestiary face: it subclasses CrystalGolemMob, so it wears that creature's
    ...
    public necesse.gfx.gameTexture.GameTexture getMobIcon() {
        return stairwaytoheaven.mobs.BorrowedMobIcon.from("crystalgolem", super.getMobIcon());
    }
