...
def gen_set_icons(dir_path):
    ...
    # Garland: a purpose-drawn icon rather than mini_from of the world cell.
    # The world sprite is a garland strung ACROSS a wall, so its top-left cell
    # is a slice of cord; drawn for the slot it reads as the object. Measured
