...
META = {
    ...
    "objects/skystonerock.png": ("Skystone-Fels", "Abbaubarer Fels. Autotile: 8 Spalten = geologische Varianten (Platte, Schichtung, Kuppeln, Bruch, Spaltung, Schutt, Verwitterung, Terrasse), 13 Reihen aus 16-px-Vierteln; Basis loest sich weich in den Schatten auf."),
    "objects/aetheriumore.png": ("Aetherium-Erz (Overlay)", "2 Muster-Varianten, die die Engine ueber den Fels maskiert."),
    "objects/stormcrystal.png": ("Sturmkristall", "2x1-Cluster, 4 asymmetrische Formationen (64px): geneigte, ueberlappende Klingen auf gemeinsamem Schuttbett - gerade Spalten = linke Haelfte, ungerade = rechte."),
    ...
    "mobs/icons/wardensettler.png": ("Der Warden als Siedler", "Siedlungs-Icon des angeworbenen Wardens: derselbe Mann ohne Kapuze, im sturmblauen Siedler-Hemd. Er zieht nach der Anwerbung in die Oberflaechen-Siedlung."),
